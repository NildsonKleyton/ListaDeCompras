...
1. [Atributos Globais mais utilizados](#atributos-globais-mais-utilizados)
   ...
   - [tabindex](#tabindex)
   - [title](#title)<!-- no toc -->
1. [Aninhamento de tags](#aninhamento-de-tags)
1. [Conteúdo do Texto e Caracteres Reservado](#conteúdo-do-texto-e-caracteres-reservado)
   - [Caracteres Reservado](#caracteres-reservado)
1. [Anatomia do Documento HTML](#anatomia-do-documento-html)
...
- **title:**
  ...
  **Ex.:**
  ```html
  <div title="Define um título">Aqui tem um titulo</div>
  ```
  **Resultado:**<br>
  <div title="Define um título">Aqui tem um titulo</div>
